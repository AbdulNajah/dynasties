...
Asher data provides us information at the assembly constituency level for the the Indian states. Here we are using it to asses the impact of dynast rule on certain constituency characteristics. In other ways this would also be an indicator of those places where you would see prolonged rule of dynast leaders.

The dependent variable corresponds to the number of years rules by a dynast ruler in a particular constituency in a 30 year period starting 1970 to 2001.  We limit our analysis to this period because the 
...
ge_09_14_19 <- read.csv ("D:/cpr/up-dynasties/dyn_other_data/tcpd_ge_09_14_19_dyn.csv")
...
tcpd_all <- read.csv ("D:/cpr/up-dynasties/dyn_other_data/tcpd_ge_09_14_19_VS_5PC.csv")
...
cen_11 <- read.csv("D:/cpr/up-dynasties/dyn_other_data/Jensenius_2016.csv")
...
adr <- read.csv("D:/cpr/up-dynasties/dyn_other_data/adr/adr_tcpd_09_14_19.csv")
...
stargazer(dyn_winner, dyn_cand, type = "html",align = TRUE, no.space = TRUE )
