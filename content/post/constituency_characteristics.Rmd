...
All the models is a poisson regression regressions. In Asher's data set all the variables have a urban and rural counter parts. The first one, we have all urban and rural variables in one model. Second  and third ones are separate urabn and rural models respectively. 
