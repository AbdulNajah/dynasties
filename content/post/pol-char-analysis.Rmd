...
fit.1 <- glm(dynast ~ N_minister+minister_duration+pre_90+post_90 +link, family =  binomial(link = "probit"))


fit.2 <- glm(dynast ~ N_minister+pre_90+post_90 +link, family =  binomial(link = "probit"))
#summary(fit)

stargazer(fit.1, fit.2,title="Regression Results",type = "html",
align=TRUE,dep.var.labels=c("Dynast - 1/0"),
