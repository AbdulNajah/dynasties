...
# 
# 
# dyn_ae_12_17 %>% filter (year == 2017 &incumbent == TRUE) %>% group_by(dyn_cum_2) %>% summarise(mean(margin_percentage))
```
...
<!-- ```{r} -->
<!-- ggplot(dyn_rafael %>% filter(position==1 & partypercent <100) , aes(dyn_cum_2_text, partypercent))+ -->
<!--   geom_boxplot() -->
<!-- ``` -->
