...
dyn_ae_w_uniq %>% arrange(-dyn_prop) %>% select(district_name, dyn_prop) %>% kable(title = "Year ruled by dynast (Proportion) ",digits =2) %>% kable_styling(bootstrap_options = "striped")
