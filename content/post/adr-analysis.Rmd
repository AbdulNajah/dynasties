...
ge_gr <- dyn_adr_ge_r %>% group_by(dyn_cum_text,year) %>% summarise(mean_assets = mean(total_assets) )
...
ae_gr <- dyn_adr_ae_r %>% group_by(dyn_cum_text,year) %>% summarise(mean_assets = mean(total_assets)) 
