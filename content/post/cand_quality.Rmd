...
<!-- ge <- read.csv(here("data","tcpd_ge_09_14_19_dyn.csv")) -->
...
<!-- adr_ge <- read.csv(here("data/adr","adr_tcpd_09_14_19.csv")) -->
...
<!-- dyn_adr_ge <- merge(ge,ge_adr, by = c("State_Name","Year", "Constituency_No", "Position")) -->
...
<!-- ge_19 <- read.csv(here("data","TCPD_2019_all_candidates_with_caste_and_political_family.csv")) -->

<!-- ge_19 <- read.csv(here("data","tcpd_ge_09_14_19_dyn.csv")) -->
...
<!-- dyn <- read.csv(here("data", "dyn_all.csv")) -->
...
<!-- adr <- read.csv(here("data", "adr_candidatelevel.csv")) -->
...
<!-- adr_12_17 <- read.csv(here("data", "dyn_adr_12_17.csv")) -->
