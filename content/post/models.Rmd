...
dyn_ae_ge_09_19_uniq <- dyn_ae_ge %>% filter(year >2008) %>% group_by(family_id) %>% arrange(-year) %>% distinct(family_id, .keep_all = TRUE)

dynast <-dyn_ae_ge_09_19_uniq$dyn_tot



caste_uc <- ifelse(dyn_ae_ge_09_19_uniq$caste_groups == "Upper Caste", TRUE,FALSE)


industry <- dyn_ae_ge_09_19_uniq$indus_count
...
pre_90 <- ifelse(dyn_ae_ge_09_19_uniq$pre_90_n >0,1,0) %>% replace_na(0)

post_90 <- ifelse(dyn_ae_ge_09_19_uniq$post_90_n >0,1,0) %>% replace_na(0)
...
link <- ifelse(dyn_ae_ge_09_19_uniq$level %in% c("AE","GE"),0,1) %>% replace_na(0)
...
# 
#  ggplot(dyn_ae_ge_09_19_uniq, aes(total_assets))+
#  geom_density()+
#  scale_x_continuous(label = label_number_si())
#  
#  table(cut(dyn_ae_ge_09_19_uniq$total_assets, breaks = c(0,20000000,50000000,Inf)))


dyn_ae_ge_09_19_uniq$total_assets_cat <- cut(dyn_ae_ge_09_19_uniq$total_assets, breaks = c(0,20000000,50000000,Inf), labels = c("Low", "Medium", "High"))


assets <- dyn_ae_ge_09_19_uniq$total_assets_cat
# assets_low <- ifelse(dyn_ae_ge_09_19_uniq$total_assets_cat== "low", 1,0)
# 
# assets_medium <- ifelse(dyn_ae_ge_09_19_uniq$total_assets_cat== "Medium", 1,0)
# 
# assets_high <- ifelse(dyn_ae_ge_09_19_uniq$total_assets_cat== "High", 1,0)
...
school <- dyn_ae_ge_09_19_uniq$school

college <- dyn_ae_ge_09_19_uniq$college

position <- ifelse(dyn_ae_ge_09_19_uniq$position==1,1,0)
